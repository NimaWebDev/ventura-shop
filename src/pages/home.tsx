    ...
    <>
        <div className='container max-w-full mt-15 relative bg-[#F5F6F9]'>
            ...
            <div className='container flex max-w-full items-center justify-center'>
                <img className='hidden lg:block w-[237px] h-[150px] absolute mr-220 mb-50' src={imageLeft} alt="image" />
                ...
                <img className='hidden lg:block w-[237px] h-[150px] absolute lg:ml-190 mt-20' src={imageRight} alt="image" />
            </div>
